# QTCode Documentation

This documentation set turns the planning prompt in [PROMPT.md](../PROMPT.md) into durable product, design, and engineering artifacts for QTCode.
...
1. [plans/architecture-and-implementation-plan.md](plans/architecture-and-implementation-plan.md)
2. [plans/roadmap.md](plans/roadmap.md)
3. [design/product-spec.md](design/product-spec.md)
4. [design/ui-layout-spec.md](design/ui-layout-spec.md)
5. [design/interaction-spec.md](design/interaction-spec.md)
6. [engineering/architecture.md](engineering/architecture.md)
7. [engineering/implementation-tasks.md](engineering/implementation-tasks.md)
8. [toolchain-requirements.md](toolchain-requirements.md)
9. [github-repo-conventions.md](github-repo-conventions.md)
...
- [plans/](plans/): overall project plans, roadmap, phases, and delivery strategy.
- [adrs/](adrs/): architecture decision records that preserve important technical choices.
...
- [github-repo-conventions.md](github-repo-conventions.md): issue, milestone, label, and pull request rules.
- [scripts/README.md](../scripts/README.md): quick reference for the repo wrapper commands.

## Source Of Truth

The current source prompt is [PROMPT.md](../PROMPT.md). These docs elaborate that prompt without generating application code.
